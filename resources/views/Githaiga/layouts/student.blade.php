...
<div class="container">
  ...
  <div class="form-group">
    ...
    <small  class="form-text text-muted">Kindly enter your Date of Birth</small>
  </div>

  <div class="form-group">
    <label for="address">Physical address</label>
    <textarea name="address" class="form-control"></textarea>
    <small id="emailHelp" class="form-text text-muted">Kindly enter your Physical Address</small>
  </div>
